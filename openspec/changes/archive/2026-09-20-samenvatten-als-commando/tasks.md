...
- [x] 1.3 Idempotent: een tweede run maakt niets opnieuw. Test dat met
  een generator die telt hoe vaak hij is aangeroepen.
- [x] 1.4 Tests draaien zonder Ollama: een nep-generator, en voor de
  database de bestaande testopzet.

## 2. Documentatie
- [x] 2.1 Hoe je het draait (lokaal en als Job), in de bestaande
